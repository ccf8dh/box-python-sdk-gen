...
from box_sdk_gen.schemas.integration_mapping_partner_item_onedrive import (
    IntegrationMappingPartnerItemOneDrive,
)
...
class IntegrationMappingOneDriveIntegrationTypeField(str, Enum):
    ONEDRIVE = 'onedrive'


class IntegrationMappingOneDrive(IntegrationMappingBase):
    def __init__(
        self,
        partner_item: Union[IntegrationMappingPartnerItemOneDrive],
        box_item: FolderReference,
        id: str,
        *,
        integration_type: Optional[IntegrationMappingOneDriveIntegrationTypeField] = None,
        ...
        **kwargs
        ...
        """
                ...
                :type partner_item: Union[IntegrationMappingPartnerItemOneDrive]
        ...
        Supports Slack, Teams, and OneDrive.
        (part of the composite key together with `id`), defaults to None
                :type integration_type: Optional[IntegrationMappingOneDriveIntegrationTypeField], optional
                :param is_overridden_by_manual_mapping: Identifies whether the mapping has
        been manually set by the user from UI
