...
- [List OneDrive integration mappings](#list-onedrive-integration-mappings)
- [Create OneDrive integration mapping](#create-onedrive-integration-mapping)
- [Update OneDrive integration mapping](#update-onedrive-integration-mapping)
- [Delete OneDrive integration mapping](#delete-onedrive-integration-mapping)
...
This operation is performed by calling function `get_onedrive_integration_mapping`.

See the endpoint docs at
[API Reference](https://developer.box.com/reference/get-integration-mappings-onedrive/).

<!-- sample get_integration_mappings_onedrive -->

```python
user_client.integration_mappings.get_onedrive_integration_mapping()
```

### Arguments

- partner_item_type `Optional[GetOneDriveIntegrationMappingPartnerItemType]`
  - Mapped item type, for which the mapping should be returned
- partner_item_id `Optional[str]`
  - ID of the mapped item, for which the mapping should be returned
- box_item_id `Optional[str]`
  - Box item ID, for which the mappings should be returned
- box_item_type `Optional[GetOneDriveIntegrationMappingBoxItemType]`
  - Box item type, for which the mappings should be returned
- extra_headers `Optional[Dict[str, Optional[str]]]`
  - Extra headers that will be included in the HTTP request.
...
This function returns a value of type `IntegrationMappingsOneDrive`.

Returns a collection of integration mappings

## Create OneDrive integration mapping
...
This operation is performed by calling function `create_onedrive_integration_mapping`.

See the endpoint docs at
[API Reference](https://developer.box.com/reference/post-integration-mappings-onedrive/).

<!-- sample post_integration_mappings_onedrive -->

```python
user_client.integration_mappings.create_onedrive_integration_mapping(
    IntegrationMappingPartnerItemOneDriveCreateRequest(
        type=IntegrationMappingPartnerItemOneDriveCreateRequestTypeField.FOLDER,
        id=partner_item_id,
        tenant_id=tenant_id,
    ),
    FolderReference(id=folder.id),
...
- box_item `FolderReference`
  -
- options `Optional[IntegrationMappingOneDriveOptions]`
  -
- extra_headers `Optional[Dict[str, Optional[str]]]`
  - Extra headers that will be included in the HTTP request.
...
This function returns a value of type `IntegrationMappingOneDrive`.

Returns the created integration mapping.

## Update OneDrive integration mapping
...
This operation is performed by calling function `update_onedrive_integration_mapping_by_id`.

See the endpoint docs at
[API Reference](https://developer.box.com/reference/put-integration-mappings-onedrive-id/).

<!-- sample put_integration_mappings_onedrive_id -->

```python
user_client.integration_mappings.update_onedrive_integration_mapping_by_id(
    integration_mapping_id, box_item=FolderReference(id="1234567")
)
```
...
## Delete OneDrive integration mapping

Deletes a [OneDrive integration mapping](https://support.box.com/hc/en-us/articles/360044481414-Using-Box-for-OneDrive).
You need Admin or Co-Admin role to
use this endpoint.

This operation is performed by calling function `delete_onedrive_integration_mapping_by_id`.

See the endpoint docs at
[API Reference](https://developer.box.com/reference/delete-integration-mappings-onedrive-id/).

<!-- sample delete_integration_mappings_onedrive_id -->

```python
user_client.integration_mappings.delete_onedrive_integration_mapping_by_id(
    integration_mapping_id
)
```
